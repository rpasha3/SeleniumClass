...
public class P0_Checkbox_Practice {
    public static void main(String[] args) throws InterruptedException {
        ...
        if(checkbox1.isSelected()) {
            System.out.println("Checkbox 1 selected. Verification PASSED!");
        } else {
            System.out.println("Checkbox 1 not selected. Verification FAILED!");
        }

        //7. Confirm checkbox #2 is NOT selected.
        if(!checkbox2.isSelected()) {
            System.out.println("Checkbox 2 not selected. Verification PASSED!");
        } else {
            System.out.println("Checkbox 2 selected. Verification FAILED!");
        }
